...
| [**dns-tls-relay**](https://github.com/ztancrell/dns-tls-relay) | Python/Bash | A fork of [DOWRIGHTTV](https://github.com/DOWRIGHTTV/) [project](https://github.com/DOWRIGHTTV/dns-tls-relay) that adds color output and a setup script. |
